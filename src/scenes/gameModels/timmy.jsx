...
export default function CharacterController({ scale, position }) {
  const group = useRef();
  const rigidBodyRef = useRef();

  const { nodes, materials, animations } = useGLTF("/models/NewTimmy.glb");
  ...
  useFrame((state, delta) => {
    ...
    if (hasInput) {
      ...
      // ✅ FIX: Only rotate character when moving forward or sideways
      ...
      // Not moving - check idle timer for sad idle
